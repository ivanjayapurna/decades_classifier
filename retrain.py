...
subfolders, each full of images for each label. The example folder yearbook_images
should have a structure like this:

~/yearbook_images/1900/photo1.png
~/yearbook_images/1900/photo2.png
...
~/yearbook_images/1950/anotherphoto77.png
...
~/yearbook_images/2000/somepicture.png
...
command like this:
```bash
python decades_retrain.py --image_dir yearbook_images --summaries_dir retrain_logs
```
...
```bash
python retrain.py --image_dir yearbook_images \
